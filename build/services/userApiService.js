...
var _isValidFormat = require("../utils/isValidFormat");
...
var getPaginateWithUsers = /*#__PURE__*/function () {
  ...
  return function getPaginateWithUsers(_x, _x2) {
    return _ref2.apply(this, arguments);
  };
}();
var createNewUser = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data) {
    var checkFormatEmail, checkFormatPhoneNumber, isEmailExists, isPhoneExists, hashPassword;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          // check user are existing
          checkFormatEmail = (0, _isValidFormat.isValidFormatEmail)(data.email);
          if (checkFormatEmail) {
            _context3.next = 4;
            break;
          }
        ...
        case 4:
          checkFormatPhoneNumber = (0, _isValidFormat.isValidFormatPhoneNumber)(data.phone);
        ...
        case 7:
          _context3.next = 9;
          return (0, _loginRegisterService.checkEmailExists)(data.email);
        case 9:
        ...
        case 12:
          _context3.next = 14;
          return (0, _loginRegisterService.checkPhoneExists)(data.phone);
        case 14:
          isPhoneExists = _context3.sent;
        ...
        case 17:
          ...
          _context3.next = 20;
          return _models["default"].User.create(_objectSpread(_objectSpread({}, data), {}, {
...
module.exports = {
  ...
  getPaginateWithUsers: getPaginateWithUsers
};